...
class HomeFragment : Fragment() {
    ...
    private fun showHowToUseDialog() {
        ...
        '예문보기' 버튼을 눌러 GPT가 제공하는 영어 예문을 확인해보세요. (인칭형 대명사는 작동하지 않을 수 있습니다.)<br>
        주의: word 칸에는 영어단어만 들어가야 하며, meaning 칸에는 한글 뜻만 들어가야 합니다.<br>
        ~();외의 특수문자 삽입시 GPT 예문 불러오기 기능이 제한됩니다.
        <br><br>
